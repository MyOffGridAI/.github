...
- **Works without internet** — Core AI, memory, knowledge, sensors, and the offline library all function with zero connectivity. Even is able to send push notifications on a local WiFi without Internet to Android devices - All built in.
