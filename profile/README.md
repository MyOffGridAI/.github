...
- **Unlike many "doomsday" or "offline" AI solutions**, MyOffGridAI is SPECIFICALLY designed to build a knowledge base about you, your hobbies, your interests, your homestead, and your additional uploaded information you provide.  Since MyOffGridAI is designed to be air-gapped off the Internet, the goal for the LLM is to gather and incorporate all data it can about you and your life.  This enables every future chat session to be more and more tailored to you and your immediate environment.  Each account that you grant for login/access to the system has their own walled-off personal data store or "Knowledge Vault" as MyOffGridAI calls it.  You can choose to move data to a shared Knowledge Vault to make it accessible to all memebers, or, keep it private and have AI only reference and use that information only with you.
